...
class GTSAM_EXPORT DynamcisCaliFactor_RS
    : public NoiseModelFactor13<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3,
                                gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3,
                                gtsam::Vector3, double, double, gtsam::Pose3, gtsam::Vector3> {
  public:
    ...
    DynamcisCaliFactor_RS(Key p_i, Key vel_i, Key omega_i, Key p_j, Key vel_j, Key omega_j,
                          Key im_key, Key rwg_key, Key p_key, Key kf_key, Key km_key, Key bTm_key,
                          Key drag_key, gtsam::Vector4 actuator_outputs, float dt, float mass,
    ...
    Vector evaluateError(
        ...
        const gtsam::Pose3& bTm, const gtsam::Vector3& drag_k,
        ...
        gtsam::OptionalMatrixType H13 = OptionalNone) const;

  private:
    typedef DynamcisCaliFactor_RS This;
    typedef NoiseModelFactor13<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3,
                               gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3,
                               gtsam::Vector3, double, double, gtsam::Pose3, gtsam::Vector3>
        Base;
...
class GTSAM_EXPORT DynamcisCaliFactor_RS_AB
    : public NoiseModelFactor15<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3,
                                gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3,
                                gtsam::Vector3, double, double, gtsam::Pose3, gtsam::Vector3,
  ...
  public:
    ...
    DynamcisCaliFactor_RS_AB(Key p_i, Key vel_i, Key omega_i, Key p_j, Key vel_j, Key omega_j,
                             Key im_key, Key rwg_key, Key p_key, Key kf_key, Key km_key,
                             Key bTm_key, Key drag_key, Key A_key, Key B_key,
                             gtsam::Vector4 actuator_outputs, float dt, float mass,
                             const SharedNoiseModel& model);
    ...
    Vector evaluateError(
        ...
        const gtsam::Vector3& inertia_torque, const gtsam::Rot3& rwg,
        const gtsam::Vector3& rotor_pos, const double& ct, const double& km,
        const gtsam::Pose3& bTm, const gtsam::Vector3& drag_k, const gtsam::Vector3& A,
        const gtsam::Vector3& B, gtsam::OptionalMatrixType H1 = OptionalNone,
        ...
        gtsam::OptionalMatrixType H12 = OptionalNone, gtsam::OptionalMatrixType H13 = OptionalNone,
        gtsam::OptionalMatrixType H14 = OptionalNone,
        gtsam::OptionalMatrixType H15 = OptionalNone) const;

    gtsam::Vector6 Thrust_Torque(const gtsam::Vector4& rpm_square, const double& ct,
                                 const double& km, const gtsam::Vector3& rotor_pos) const;
    gtsam::Vector6 Thrust_Torque(const gtsam::Vector4& rpm_square, const double& ct,
  ...
  private:
    ...
    typedef NoiseModelFactor15<gtsam::Pose3, gtsam::Vector3, gtsam::Vector3, gtsam::Pose3,
                               gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3,
                               gtsam::Vector3, double, double, gtsam::Pose3, gtsam::Vector3,
                               gtsam::Vector3, gtsam::Vector3>
        Base;
...
/*Motor speed factor*/
// rpm2 = rpm1 + k * pwm
class GTSAM_EXPORT RPM_TC_Factor
    : public NoiseModelFactor3<gtsam::Vector4, gtsam::Vector4, double> {
  public:
    typedef boost::shared_ptr<RPM_TC_Factor> shared_ptr;

    RPM_TC_Factor() {}

    RPM_TC_Factor(Key rpm1_key, Key rpm2_key, Key kkey, gtsam::Vector4& pwm,
                  const SharedNoiseModel& model)
        : Base(model, rpm1_key, rpm2_key, kkey), pwm_(pwm){};
  ...
  private:
    ...
    typedef NoiseModelFactor3<gtsam::Vector4, gtsam::Vector4, double> Base;
...
class GTSAM_EXPORT DynamcisCaliFactor_TM
  ...
  public:
    ...
    DynamcisCaliFactor_TM(Key p_i, Key vel_i, Key omega_i, Key tm_ij, Key p_j, Key vel_j,
                          Key omega_j, Key im_key, Key rwg_key, float dt, float mass,
                          const SharedNoiseModel& model);
    ...
    Vector evaluateError(
        ...
        const gtsam::Vector3& omega_j, const gtsam::Vector3& inertia_torque, const gtsam::Rot3& rwg,
        gtsam::OptionalMatrixType H1 = OptionalNone, gtsam::OptionalMatrixType H2 = OptionalNone,
        gtsam::OptionalMatrixType H3 = OptionalNone, gtsam::OptionalMatrixType H4 = OptionalNone,
        gtsam::OptionalMatrixType H5 = OptionalNone, gtsam::OptionalMatrixType H6 = OptionalNone,
        gtsam::OptionalMatrixType H7 = OptionalNone, gtsam::OptionalMatrixType H8 = OptionalNone,
        gtsam::OptionalMatrixType H9 = OptionalNone) const;
...
class GTSAM_EXPORT AllocationCalibFactor
    : public NoiseModelFactor7<gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3, double,
                               double, double> {
  public:
    ...
    AllocationCalibFactor(Key thrust_key, Key torques_key, Key rotor_pos_key, Key rotor_axis_key,
        ...
        : Base(model, thrust_key, torques_key, rotor_pos_key, rotor_axis_key, ct_key, km_key,
               k_esc_key),
          actuatorEffectivenessRotors_(actuatorEffectivenessRotors), actuators_(actuators){};
  ...
  private:
    ...
    typedef NoiseModelFactor7<gtsam::Vector3, gtsam::Vector3, gtsam::Vector3, gtsam::Rot3, double,
                              double, double>
        Base;
...
// Allocation Control Factor 3 <thrust_torques, rotor_pos of rotor1, ct of thrust model, km of
// inertia torques model>.
class GTSAM_EXPORT AllocationCalibFactor3
    : public NoiseModelFactor4<gtsam::Vector6, gtsam::Vector3, double, double> {
  public:
    ...
    AllocationCalibFactor3(Key thrust_torques_key, Key rotor_pos_key, Key ct_key, Key km_key,
                           gtsam::Vector4& actuators, const SharedNoiseModel& model)
        : Base(model, thrust_torques_key, rotor_pos_key, ct_key, km_key), actuators_(actuators){};
  ...
  private:
    ...
    typedef NoiseModelFactor4<gtsam::Vector6, gtsam::Vector3, double, double> Base;
...
class GTSAM_EXPORT MotorCalibFactor : public NoiseModelFactor1<gtsam::Vector5> {
  public:
    ...
    MotorCalibFactor(Key s3_key, double battery_voltage, double pwm, double rotor_speed1,
                     double rotor_speed2, double dt, const SharedNoiseModel& model)
        : Base(model, s3_key), battery_voltage_(battery_voltage), pwm_(pwm),
          rotor_speed1_(rotor_speed1), rotor_speed2_(rotor_speed2), dt_(dt){};

    virtual ~MotorCalibFactor() {}

    Vector evaluateError(const gtsam::Vector5& params,
