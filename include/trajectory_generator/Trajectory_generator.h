...
namespace Trajectory
{
    ...
    public:
        ...
        gtsam::Vector3 vel(double t)
        {
            ...
            // std::cout << "1 vel: " << vel.transpose() << std::endl;
            // vel = gtsam::Vector3(v_x, v_y, 0);
            // std::cout << "2 vel: " << vel.transpose() << std::endl;
            return vel;
        }
        ...
        gtsam::Vector3 omega(double t)
        {
            ...
            // return (theta(t + dt_) - theta(t)) / dt_;
        }
        ...
        gtsam::Vector3 thrust(double t)
        {
            ...
            force = gtsam::Vector3(-sin(angular_speed* t)* angular_speed* angular_speed* radius_,
                           ...
                           0)  + g_;
            // std::cout << "1 force: " << force.transpose() << std::endl;
            // force = (vel(t + dt_) - vel(t)) / dt_ + g_;
            // std::cout << "2 force: " << force.transpose() << std::endl;
            return force;
        }
