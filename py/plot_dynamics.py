...
# plt.plot((timestamp - timestamp[0]), hor_thrust + thrust_ez + df_ez + dyn_vel_err_z *100, color = 'darkblue', linestyle='--')
...
# savefig(plt,'figures/Body-z force and ground truth (GT)')


plt.figure(4)
plt.plot((timestamp - timestamp[0]), hor_thrust + thrust_ez, color = 'darkred', linestyle='-')
plt.plot((timestamp - timestamp[0]), hor_thrust + thrust_ez + dyn_vel_err_z *100, color = 'darkblue', linestyle='--')
...
plt.figure(10)
plt.plot((timestamp - timestamp[0]), tq_ez, color = 'darkred', linestyle='-')
plt.plot((timestamp - timestamp[0]), tq_ez + dyn_ome_err_z*100, color = 'darkblue', linestyle='--')
# plt.plot((timestamp - timestamp[0]), hor_thrust, color = 'black', linestyle='-')
plt.legend(['z', 'GT'])
plt.xlabel('Time (s)') #注意后面的字体属性
plt.ylabel('Torque (N*m)')
